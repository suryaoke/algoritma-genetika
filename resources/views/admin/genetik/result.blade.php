                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Hasil Generate Algoritma</h3>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="btn btn-warning btn-block"
                                        href="{{ route('admin.generates', request()->all()) }}">
                                        <span class="glyphicon glyphicon-hand-left"></span> Kembali
                                    </a>
                                </div>
                                <div class="col-md-4" style="padding-bottom: 3%;">
                                    <a class="btn btn-info btn-block" href="{{ route('admin.generates.excel', $id) }}">
                                        <span class="glyphicon glyphicon-download"></span> Export Excel Data Ini
                                    </a>
                                </div>
                                <div class="col-md-4" style="padding-bottom: 3%;">
